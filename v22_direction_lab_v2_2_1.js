...
const VERSION = "DIRECTION_LAB_V2.2.1";
const SCHEMA_VERSION = 1;
const STATE_KEY = "v221:state";
const INDEX_KEY = "v221:eventIndex";
const EVENT_PREFIX = "v221:event:";
    ...
    if (u.pathname === "/start" && req.method === "POST") {
      if (!this.running) {
        ...
        try {
          ...
          this.running = false;
          try { this.ws?.close(1011, "startup failed"); } catch {}
          this.ws = null;
