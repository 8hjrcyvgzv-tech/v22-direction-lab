...
const VERSION = "DIRECTION_LAB_V2.2.2";
const SCHEMA_VERSION = 1;
const STATE_KEY = "v222:state";
const INDEX_KEY = "v222:eventIndex";
const EVENT_PREFIX = "v222:event:";
...
function store(env) {
  if (env.DIRECTION_LAB?.getByName) return env.DIRECTION_LAB.getByName("v222:lab");
  const id = env.DIRECTION_LAB.idFromName("v222:lab");
